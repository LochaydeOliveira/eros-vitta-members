...
try {
    ...
    if (!$databaseExists) {
        ...
        // error_log("Banco '" . DB_NAME . "' criado."); // Removido para evitar output prematuro
    }
...
function createTables($pdo) {
    ...
    try {
        ...
        if ($stmt->fetchColumn() == 0) {
            ...
            // error_log("Usuário admin criado: admin@exemplo.com"); // Removido para evitar output prematuro
        }
        ...
        if ($stmt->fetchColumn() == 0) {
            ...
            // error_log("Usuário Vera Soares criado: veramdssoares@gmail.com"); // Removido para evitar output prematuro
        }
